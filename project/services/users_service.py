...
from project.tools.security import generate_password_hash, approved_refresh_token, generate_tokens, get_data_from_token
...
class UsersService:
    ...
    def update_token(self, refresh_token):
        return approved_refresh_token(refresh_token)
